...
with the respective figures and tables in the paper (Figures 4,5,6 and 7; Tables 1 and 2). The plots should be identical, with very minimal variation from the results in the paper.
