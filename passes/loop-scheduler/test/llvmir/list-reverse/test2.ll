...
3:                                                ; preds = %._crit_edge5, %._crit_edge1
  %4 = phi %struct.list_head_s* [ %23, %._crit_edge5 ], [ %0, %._crit_edge1 ], !ics_resolved_load_use !12
  %5 = phi %struct.list_head_s* [ %15, %._crit_edge5 ], [ null, %._crit_edge1 ], !ics_resolved_load_use !12
  ...
  br i1 %8, label %._crit_edge2, label %11, !llvm.loop !13

._crit_edge2:                                     ; preds = %3
  %.lcssa8 = phi %struct.list_head_s* [ %4, %3 ]
  store %struct.list_head_s* %5, %struct.list_head_s** %6, align 4, !tbaa !10, !ics_write_early_exit !12
  br label %9
...
11:                                               ; preds = %3
  ...
  %13 = load %struct.list_head_s*, %struct.list_head_s** %12, align 4, !tbaa !10, !ics_resolved_load !12
  %14 = icmp eq %struct.list_head_s** %12, %6, !ics_resolved_load_icmp !12
  %15 = select i1 %14, %struct.list_head_s* %5, %struct.list_head_s* %13, !ics_resolved_load_select !12
  %16 = icmp eq %struct.list_head_s* %15, null, !ics_resolved_load_use !12
  br i1 %16, label %._crit_edge3, label %17, !llvm.loop !13

._crit_edge3:                                     ; preds = %11
  %.lcssa6 = phi %struct.list_head_s* [ %7, %11 ]
  store %struct.list_head_s* %5, %struct.list_head_s** %6, align 4, !tbaa !10, !ics_write_early_exit !12
  store %struct.list_head_s* %4, %struct.list_head_s** %12, align 4, !tbaa !10, !ics_write_early_exit !12
  br label %9

17:                                               ; preds = %11
  %18 = getelementptr inbounds %struct.list_head_s, %struct.list_head_s* %15, i32 0, i32 0, !ics_resolved_load_use !12
  %19 = load %struct.list_head_s*, %struct.list_head_s** %18, align 4, !tbaa !10, !ics_resolved_load !12
  %20 = icmp eq %struct.list_head_s** %18, %6, !ics_resolved_load_icmp !12
  %21 = select i1 %20, %struct.list_head_s* %5, %struct.list_head_s* %19, !ics_resolved_load_select !12
  %22 = icmp eq %struct.list_head_s** %18, %12, !ics_resolved_load_icmp !12
  %23 = select i1 %22, %struct.list_head_s* %4, %struct.list_head_s* %21, !ics_resolved_load_select !12
  %24 = icmp eq %struct.list_head_s* %23, null, !ics_resolved_load_use !12
  br i1 %24, label %._crit_edge4, label %._crit_edge5, !llvm.loop !15

._crit_edge5:                                     ; preds = %17
  store %struct.list_head_s* %5, %struct.list_head_s** %6, align 4, !tbaa !10, !ics_moved_write !12
  store %struct.list_head_s* %4, %struct.list_head_s** %12, align 4, !tbaa !10, !ics_moved_write !12
  store %struct.list_head_s* %7, %struct.list_head_s** %18, align 4, !tbaa !10, !ics_moved_write !12
  br label %3

._crit_edge4:                                     ; preds = %17
  %.lcssa12 = phi %struct.list_head_s* [ %15, %17 ], !ics_resolved_load_use !12
  store %struct.list_head_s* %5, %struct.list_head_s** %6, align 4, !tbaa !10, !ics_write_early_exit !12
  store %struct.list_head_s* %4, %struct.list_head_s** %12, align 4, !tbaa !10, !ics_write_early_exit !12
  store %struct.list_head_s* %7, %struct.list_head_s** %18, align 4, !tbaa !10, !ics_write_early_exit !12
  br label %9
}

; Function Attrs: naked noinline nounwind
define dso_local arm_aapcscc void @Reset_Handler() #4 {
  tail call void asm sideeffect "    ldr    r0, =0xE000ED08\0A    ldr    r1, =g_am_pfnVectors\0A    str    r1, [r0]", ""() #6, !srcloc !17
  tail call void asm sideeffect "    ldr    sp, [r1]", ""() #6, !srcloc !18
  tail call void asm sideeffect "    ldr     r0, =_init_data\0A    ldr     r1, =_sdata\0A    ldr     r2, =_edata\0Acopy_loop:\0A        ldr   r3, [r0], #4\0A        str   r3, [r1], #4\0A        cmp     r1, r2\0A        blt     copy_loop\0A", ""() #6, !srcloc !19
  tail call void asm sideeffect "    ldr     r0, =_sbss\0A    ldr     r1, =_ebss\0A    mov     r2, #0\0Azero_loop:\0A        cmp     r0, r1\0A        it      lt\0A        strlt   r2, [r0], #4\0A        blt     zero_loop", ""() #6, !srcloc !20
  tail call void asm sideeffect "    bl   main\0A", ""() #6, !srcloc !21
  tail call void asm sideeffect "    bkpt     ", ""() #6, !srcloc !22
  unreachable
}
...
!12 = !{!"ics_scheduler"}
!13 = distinct !{!13, !14}
!14 = !{!"llvm.loop.unroll.count", i32 3}
!15 = distinct !{!15, !16}
!16 = !{!"llvm.loop.unroll.disable"}
!17 = !{i32 12926, i32 12968, i32 13014}
!18 = !{i32 13092}
!19 = !{i32 13445, i32 13488, i32 13526, i32 13564, i32 13589, i32 13630, i32 13671, i32 13708}
!20 = !{i32 13797, i32 13835, i32 13872, i32 13905, i32 13930, i32 13967, i32 14000, i32 14043}
!21 = !{i32 14154}
!22 = !{i32 14261}
