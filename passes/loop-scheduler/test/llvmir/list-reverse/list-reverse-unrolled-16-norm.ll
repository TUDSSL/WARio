; ModuleID = 'list-reverse-unrolled-16.ll'
...
31:                                               ; preds = %20
  ...
  br i1 %exitcond.2, label %33, label %._crit_edge2

._crit_edge2:                                     ; preds = %31
  br label %5
...
44:                                               ; preds = %33
  ...
  br i1 %exitcond.3, label %46, label %._crit_edge3
...
57:                                               ; preds = %46
  ...
  br i1 %exitcond.4, label %59, label %._crit_edge4
...
70:                                               ; preds = %59
  ...
  br i1 %exitcond.5, label %72, label %._crit_edge5

._crit_edge5:                                     ; preds = %70
  br label %5
...
83:                                               ; preds = %72
  ...
  br i1 %exitcond.6, label %85, label %._crit_edge6
...
96:                                               ; preds = %85
  ...
  br i1 %exitcond.7, label %98, label %._crit_edge7

._crit_edge7:                                     ; preds = %96
  br label %5
...
109:                                              ; preds = %98
  ...
  br i1 %exitcond.8, label %111, label %._crit_edge8
...
122:                                              ; preds = %111
  ...
  br i1 %exitcond.9, label %124, label %._crit_edge9
...
135:                                              ; preds = %124
  ...
  br i1 %exitcond.10, label %137, label %._crit_edge10
...
148:                                              ; preds = %137
  ...
  br i1 %exitcond.11, label %150, label %._crit_edge11

._crit_edge11:                                    ; preds = %148
  br label %5
...
161:                                              ; preds = %150
  ...
  br i1 %exitcond.12, label %163, label %._crit_edge12
...
174:                                              ; preds = %163
  ...
  br i1 %exitcond.13, label %176, label %._crit_edge13
...
187:                                              ; preds = %176
  ...
  br i1 %exitcond.14, label %189, label %._crit_edge14

._crit_edge14:                                    ; preds = %187
  br label %5
...
200:                                              ; preds = %189
  ...
  br i1 %exitcond.15, label %202, label %._crit_edge15
...
35:                                               ; preds = %25
  ...
  br i1 %44, label %45, label %._crit_edge4
...
45:                                               ; preds = %35
  ...
  br i1 %54, label %55, label %._crit_edge5
...
65:                                               ; preds = %55
  ...
  br i1 %74, label %75, label %._crit_edge7
...
85:                                               ; preds = %75
  ...
  br i1 %94, label %95, label %._crit_edge9
...
115:                                              ; preds = %105
  ...
  br i1 %124, label %125, label %._crit_edge12
...
125:                                              ; preds = %115
  ...
  br i1 %134, label %135, label %._crit_edge13
...
135:                                              ; preds = %125
  ...
  br i1 %144, label %145, label %._crit_edge14

._crit_edge14:                                    ; preds = %135
  br label %14
...
145:                                              ; preds = %135
  ...
  br i1 %154, label %155, label %._crit_edge15
...
._crit_edge3:                                     ; preds = %15
  %.lcssa62 = phi %struct.list_head_s* [ %12, %15 ]
  br label %9
...
._crit_edge4:                                     ; preds = %20
  %.lcssa76 = phi %struct.list_head_s* [ %17, %20 ]
  br label %9
...
25:                                               ; preds = %20
  ...
  br i1 %29, label %30, label %._crit_edge5

._crit_edge5:                                     ; preds = %25
  %.lcssa89 = phi %struct.list_head_s* [ %22, %25 ]
  br label %9
...
._crit_edge6:                                     ; preds = %30
  %.lcssa101 = phi %struct.list_head_s* [ %27, %30 ]
  br label %9
...
35:                                               ; preds = %30
  ...
  br i1 %39, label %40, label %._crit_edge7

._crit_edge7:                                     ; preds = %35
  %.lcssa112 = phi %struct.list_head_s* [ %32, %35 ]
  br label %9
...
40:                                               ; preds = %35
  ...
  br i1 %44, label %45, label %._crit_edge8

._crit_edge8:                                     ; preds = %40
  %.lcssa122 = phi %struct.list_head_s* [ %37, %40 ]
  br label %9
...
45:                                               ; preds = %40
  ...
  br i1 %49, label %50, label %._crit_edge9

._crit_edge9:                                     ; preds = %45
  %.lcssa131 = phi %struct.list_head_s* [ %42, %45 ]
  br label %9
...
50:                                               ; preds = %45
  ...
  br i1 %54, label %55, label %._crit_edge10

._crit_edge10:                                    ; preds = %50
  %.lcssa139 = phi %struct.list_head_s* [ %47, %50 ]
  br label %9
...
55:                                               ; preds = %50
  ...
  br i1 %59, label %60, label %._crit_edge11

._crit_edge11:                                    ; preds = %55
  %.lcssa146 = phi %struct.list_head_s* [ %52, %55 ]
  br label %9
...
._crit_edge12:                                    ; preds = %60
  %.lcssa152 = phi %struct.list_head_s* [ %57, %60 ]
  br label %9
...
65:                                               ; preds = %60
  ...
  br i1 %69, label %70, label %._crit_edge13

._crit_edge13:                                    ; preds = %65
  %.lcssa157 = phi %struct.list_head_s* [ %62, %65 ]
  br label %9
...
._crit_edge14:                                    ; preds = %70
  %.lcssa161 = phi %struct.list_head_s* [ %67, %70 ]
  br label %9
...
75:                                               ; preds = %70
  ...
  br i1 %79, label %80, label %._crit_edge15

._crit_edge15:                                    ; preds = %75
  %.lcssa164 = phi %struct.list_head_s* [ %72, %75 ]
  br label %9
