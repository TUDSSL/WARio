...
4:                                                ; preds = %31, %3
  %.01 = phi %struct.list_head_s* [ %2, %3 ], [ %24, %31 ], !lws_unrolled_loop !10, !lws_unroll_2 !10
  %.0 = phi i32 [ 0, %3 ], [ %32, %31 ]
...
2:                                                ; preds = %15, %1
  %.0 = phi %struct.list_head_s* [ %0, %1 ], [ %23, %15 ], !lws_unrolled_loop !10, !lws_unroll_2 !10
...
2:                                                ; preds = %10, %1
  %.01 = phi %struct.list_head_s* [ null, %1 ], [ %6, %10 ], !lws_unrolled_loop !10, !lws_unroll_2 !10
