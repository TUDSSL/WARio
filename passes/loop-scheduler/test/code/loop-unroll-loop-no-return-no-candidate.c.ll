; ModuleID = 'loop-no-return-no-candidate.c.ll'
source_filename = "loop-no-return-no-candidate.c"
...
2:                                                ; preds = %1
  %3 = load i32, i32* @war_1, align 4, !tbaa !3
  store i32 1, i32* @war_1, align 4, !tbaa !3
  br label %1
}
