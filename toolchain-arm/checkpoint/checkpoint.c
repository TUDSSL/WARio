 ...
 *
 * Checkpoint layout
 * | R3 | R4 | R5 | R6 | R7 | R8 | R9 | R10 | R11 | R12 | R13/SP | R14/LR | PSR | R0 | R1 | R2 |
 *
...
volatile uint32_t __first_boot = 1;
...
void __checkpoint(void) {
    ...
    LIBCP_ASM("mov r4, lr");            // load lr into r4
    ...
    LIBCP_ASM("ldmia r2, {r0-r2}");     // restore r0-r2
