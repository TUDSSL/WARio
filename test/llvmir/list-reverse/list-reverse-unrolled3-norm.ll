; ModuleID = 'list-reverse-unrolled3.ll'
...
3:                                                ; preds = %._crit_edge5, %._crit_edge1
  %4 = phi %struct.list_head_s* [ %17, %._crit_edge5 ], [ %0, %._crit_edge1 ]
  %5 = phi %struct.list_head_s* [ %13, %._crit_edge5 ], [ null, %._crit_edge1 ]
...
11:                                               ; preds = %3
  ...
  br i1 %14, label %._crit_edge3, label %15, !llvm.loop !12
...
15:                                               ; preds = %11
  ...
  br i1 %18, label %._crit_edge4, label %._crit_edge5, !llvm.loop !14

._crit_edge5:                                     ; preds = %15
  br label %3

._crit_edge4:                                     ; preds = %15
  %.lcssa12 = phi %struct.list_head_s* [ %13, %15 ]
  br label %9
}
